 ...
 */
@Service
public class FillFundSixMonthGrowthFactory implements FundDetailInterface , InitializingBean {
    @Autowired
    ...
    public void fillFundDetail(String input, FundDTO fundDTODetail) {
        ...
        fundDTODetail.setLastSixMonthsGrowth(StringUtil.getSubValue(input));
    }

    @Override
    public void afterPropertiesSet()  {
        fillFundDetailFactoryService.registerOnFactory(FundOptionalEnum.FUND_SIX_MONTHS.getOptionalName(),this);
    }
}
