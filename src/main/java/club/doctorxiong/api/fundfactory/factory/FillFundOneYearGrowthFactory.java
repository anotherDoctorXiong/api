 ...
 * @description: 填充基金近一年增长
 * @date 2021/1/30 14:17
 */
@Service
public class FillFundOneYearGrowthFactory implements FundDetailInterface , InitializingBean {
    @Autowired
    ...
    public void fillFundDetail(String input, FundDTO fundDTODetail) {
        fundDTODetail.setLastYearGrowth(StringUtil.getSubValue(input));
    }

    @Override
    public void afterPropertiesSet()  {
        fillFundDetailFactoryService.registerOnFactory(FundOptionalEnum.FUND_ONE_YEAR.getOptionalName(),this);
    }
}
