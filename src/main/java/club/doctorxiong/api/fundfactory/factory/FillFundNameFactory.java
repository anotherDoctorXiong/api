 ...
 */
@Service
public class FillFundNameFactory implements FundDetailInterface , InitializingBean {
    @Autowired
    ...
    public void fillFundDetail(String input, FundDTO fundDTODetail) {
        fundDTODetail.setName(StringUtil.getSubValue(input));
    }

    @Override
    public void afterPropertiesSet()  {
        fillFundDetailFactoryService.registerOnFactory(FundOptionalEnum.FUND_NAME.getOptionalName(),this);
    }
}
