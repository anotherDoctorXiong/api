 ...
 * @description: 填充基金进一个月增长
 * @date 2021/1/30 14:17
 */
@Service
public class FillFundOneMonthGrowthFactory implements FundDetailInterface , InitializingBean {
    @Autowired
    ...
    public void fillFundDetail(String input, FundDTO fundDTODetail) {
        fundDTODetail.setLastMonthGrowth(StringUtil.getSubValue(input));
    }

    @Override
    public void afterPropertiesSet()  {
        fillFundDetailFactoryService.registerOnFactory(FundOptionalEnum.FUND_ONE_MONTHS.getOptionalName(),this);
    }
}
