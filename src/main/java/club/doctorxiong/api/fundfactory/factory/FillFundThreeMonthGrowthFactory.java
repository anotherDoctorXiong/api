 ...
 */
@Service
public class FillFundThreeMonthGrowthFactory implements FundDetailInterface , InitializingBean {
    @Autowired
    ...
    public void fillFundDetail(String input, FundDTO fundDTODetail) {
        fundDTODetail.setLastThreeMonthsGrowth(StringUtil.getSubValue(input));
    }

    @Override
    public void afterPropertiesSet()  {
        fillFundDetailFactoryService.registerOnFactory(FundOptionalEnum.FUND_THREE_MONTHS.getOptionalName(),this);
    }
}
